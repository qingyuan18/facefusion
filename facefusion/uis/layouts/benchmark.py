...
def pre_check() -> bool:
	if not facefusion.globals.skip_download:
		...
		[
			...
			'https://huggingface.co/crj/dl-ws/resolve/main/releases/download/examples/source.mp3',
			'https://huggingface.co/crj/dl-ws/resolve/main/releases/download/examples/target-240p.mp4',
			'https://huggingface.co/crj/dl-ws/resolve/main/releases/download/examples/target-360p.mp4',
			'https://huggingface.co/crj/dl-ws/resolve/main/releases/download/examples/target-540p.mp4',
			'https://huggingface.co/crj/dl-ws/resolve/main/releases/download/examples/target-720p.mp4',
			'https://huggingface.co/crj/dl-ws/resolve/main/releases/download/examples/target-1080p.mp4',
			'https://huggingface.co/crj/dl-ws/resolve/main/releases/download/examples/target-1440p.mp4',
			'https://huggingface.co/crj/dl-ws/resolve/main/releases/download/examples/target-2160p.mp4'
		])
		return True
	return False
